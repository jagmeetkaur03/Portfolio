    ...
    >
      <div className='flex flex-col items-center justify-start w-full'>
        ...
        >
          ...
          send me an{" "}
          <a className='text-[#74aabc] ml-1' href='#'>
            Email.
          </a>
        </p>
        <a
          href='mailto:jagmeetkaur20016@gmail.com?subject='
          target='_blank'
          rel='noreferrer'
        >
      ...
      <div className='flex items-center justify-between w-full mt-20 mb-8 md:hidden'>
        <a
          href='https://github.com/jagmeetkaur03'
          target='_blank'
          rel='noreferrer'
        >
        ...
        {/* ERROR */}
        <a
          href='https://www.linkedin.com/in/jagmeet-kaur-329b471a4/'
          target='_blank'
          rel='noreferrer'
        >
      ...
      <div className='flex flex-col items-center justify-center w-full mb-2 md:mt-20 lg:mb-3 xl:mb-5 '>
        <p className='text-xs font-light text-[#74aabc] xl:text-sm'>
          Handcrafted by Jagmeet Kaur © 2023
        </p>
      </div>
